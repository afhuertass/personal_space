defmodule PersonalSpace.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind personal_space", "esbuild personal_space"],
      "assets.deploy": [
        "tailwind personal_space --minify",
        "esbuild personal_space --minify",
        "phx.digest"
      ],
